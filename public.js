var $=(function () {
    ...
    // 11.addClass 给一个元素增加一个或者多个class名
    function addClass(curEle,classStr){
        // 将classStr首尾空格去掉,就是将它替换成空字符串''
        classStr = classStr.replace(/^ +| +$/,'');
        
        // 按照一到多个空格将classStr拆分为数组，每一项都是一个class名
        var ary = classStr.split(/ +/g);
        // 循环数组，将数组中的每一项当做当前元素的class名，给当前元素加上class
